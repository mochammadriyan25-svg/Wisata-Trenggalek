...
class _DetailPageState extends State<DetailPage> {
  ...
  Future<void> _checkFavorite() async {
    // Guest tidak perlu cek, skip langsung
  ...
  Future<void> _toggleFavorite() async {
    if (_isFavorite) {
      await _favoriteService.removeFavorite(_userId, widget.destination.id);
    } else {
      await _favoriteService.addFavorite(_userId, widget.destination.id);
    }
            ...
            GestureDetector(
              ...
              child: const Row(
                children: [
                  ...
                  SizedBox(width: 4),
                  Icon(Icons.chevron_right, size: 18, color: Color(0xFF059669)),
                ],
              ),
            ),
          ],
                      ...
                      Positioned.fill(
                        child: Center(
                          child: GestureDetector(
                            onTap: () => _openUrl(item.maps360Url),
                            child: Container(
                        ...
                        children: [
                          Expanded(
                            child: ElevatedButton.icon(
                              // ============================================================
                              // AUTH GUARD: Guest akan ditampilkan bottom sheet login
                              // Logged-in user langsung toggle favorite
                              // ============================================================
                              onPressed: () {
